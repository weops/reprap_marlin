...
#define STRING_CONFIG_H_AUTHOR "(CodingPeon, default config)" // Who made the changes.
...
#define Z_SERVO_ANGLES {96,0} // Z Servo Deploy and Stow angles
